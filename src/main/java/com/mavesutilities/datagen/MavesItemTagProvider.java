...
public class MavesItemTagProvider extends FabricTagProvider.ItemTagProvider {
    ...
    protected void configure(RegistryWrapper.WrapperLookup wrapperLookup) {
        ...
        getOrCreateTagBuilder(MavesTags.Items.COCOA_TREE_LOGS)
        ...
        getOrCreateTagBuilder(ItemTags.LOGS_THAT_BURN)
                ...
                .addTag(MavesTags.Items.COCOA_TREE_LOGS)
        ...
        getOrCreateTagBuilder(ItemTags.WOODEN_BUTTONS)
                ...
                .add(MavesBlocks.COCOA_TREE_BUTTON.asItem())
        ...
        getOrCreateTagBuilder(ItemTags.WOODEN_DOORS)
                ...
                .add(MavesBlocks.COCOA_TREE_DOOR.asItem())
        ...
        getOrCreateTagBuilder(ItemTags.FENCE_GATES)
                ...
                .add(MavesBlocks.COCOA_TREE_FENCE_GATE.asItem())
        ...
        getOrCreateTagBuilder(ItemTags.WOODEN_FENCES)
                ...
                .add(MavesBlocks.COCOA_TREE_FENCE.asItem())
        ...
        getOrCreateTagBuilder(ItemTags.WOODEN_PRESSURE_PLATES)
                ...
                .add(MavesBlocks.COCOA_TREE_PRESSURE_PLATE.asItem())
        ...
        getOrCreateTagBuilder(ItemTags.WOODEN_SLABS)
                ...
                .add(MavesBlocks.COCOA_TREE_SLAB.asItem())
        ...
        getOrCreateTagBuilder(ItemTags.WOODEN_STAIRS)
                ...
                .add(MavesBlocks.COCOA_TREE_STAIRS.asItem())
        ...
        getOrCreateTagBuilder(ItemTags.WOODEN_TRAPDOORS)
                ...
                .add(MavesBlocks.COCOA_TREE_TRAPDOOR.asItem())
