...
public class MavesCompostableItems {
    ...
    public static void registerMavesCompostableItems() {
        ...
        CompostingChanceRegistry.INSTANCE.add(MavesItems.PALE_PUMPKIN_SEEDS, 0.3f);
        ...
        CompostingChanceRegistry.INSTANCE.add(MavesItems.OAK_FLOWERING_LEAVES, 0.5f);
        CompostingChanceRegistry.INSTANCE.add(MavesItems.PALE_OAK_FLOWERING_LEAVES, 0.5f);
        CompostingChanceRegistry.INSTANCE.add(MavesItems.APPLE_TREE_FLOWERING_LEAVES, 0.5f);
        CompostingChanceRegistry.INSTANCE.add(MavesItems.APPLE_TREE_FLOWERED_LEAVES, 0.5f);
        CompostingChanceRegistry.INSTANCE.add(MavesItems.PALE_PUMPKIN, 0.65f);
        CompostingChanceRegistry.INSTANCE.add(MavesItems.CARVED_PALE_PUMPKIN, 0.65f);
    }
}
